...
//---------------------------------------------------------------------------------+
// Shortcut to convert char to std::string                                         |
//---------------------------------------------------------------------------------+
std::vector<std::string> Split(std::string haystack, char delimiter) {
    std::string s(1, delimiter);
    return Split(haystack, s);
}

//---------------------------------------------------------------------------------+
// Shortcut to convert const char* to std::string                                  |
//---------------------------------------------------------------------------------+
...
std::vector<std::string> Split(std::string haystack, std::string delimiter) {
    ...
    while (pos != std::string::npos) {
        ...
        haystack = haystack.substr(pos + inc, std::string::npos);
